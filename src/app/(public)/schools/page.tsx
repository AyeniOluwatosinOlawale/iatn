...
const SAMPLE_SCHOOLS = [
  ...
  {
    id: '3',
    registration_number: 'IATN-SCH-2026-0003',
    school_name: 'Loyola Jesuit College',
    logo_initial: 'LJ',
    state: 'FCT - Abuja', city: 'Abuja',
    school_type: 'private',
    curricula: ['igcse', 'a_level'],
    founded_year: 2000,
    student_count: 1200,
    fee_range_ngn_min: 4000000,
    fee_range_ngn_max: 6000000,
    is_verified: true,
    overall_rating: 4.9,
    review_count: 156,
    a_star_a_rate: 91.5,
    university_placement_rate: 98,
  ...
  {
    id: '4',
    registration_number: 'IATN-SCH-2026-0004',
    school_name: 'Atlantic Hall',
    logo_initial: 'AH',
    state: 'Lagos', city: 'Epe',
    school_type: 'international',
    curricula: ['igcse', 'a_level', 'ib'],
    founded_year: 1994,
    student_count: 900,
    fee_range_ngn_min: 5000000,
    fee_range_ngn_max: 8000000,
    is_verified: true,
    overall_rating: 4.8,
    review_count: 132,
    a_star_a_rate: 88.4,
    university_placement_rate: 97,
    about: 'International boarding school offering Cambridge IGCSE, A-Level, and IB Diploma in a stunning lakeside campus. Strong arts and sports programmes.',
    tags: ['Cambridge + IB', 'Full Boarding', 'International Campus'],
  },
  {
    id: '5',
    registration_number: 'IATN-SCH-2026-0005',
    school_name: 'Whiteplains British School',
    logo_initial: 'WB',
    state: 'FCT - Abuja', city: 'Abuja',
    school_type: 'private',
    curricula: ['igcse', 'a_level'],
    founded_year: 2005,
    student_count: 800,
    fee_range_ngn_min: 3500000,
    fee_range_ngn_max: 5500000,
    is_verified: true,
    overall_rating: 4.7,
    review_count: 98,
    a_star_a_rate: 79.6,
    university_placement_rate: 92,
  ...
  {
    id: '6',
    registration_number: 'IATN-SCH-2026-0006',
    ...
    founded_year: 1942,
    student_count: 600,
    fee_range_ngn_min: 2800000,
    fee_range_ngn_max: 4200000,
    is_verified: true,
    overall_rating: 4.8,
    review_count: 87,
    a_star_a_rate: 84.2,
    university_placement_rate: 95,
...
const curriculaLabels: Record<string, string> = {
...
export default function SchoolsPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <div className="iatn-gradient-purple text-white py-14 px-4" style={{ background: 'linear-gradient(135deg, #533483 0%, #0f3460 100%)' }}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-xl p-2 flex flex-col sm:flex-row gap-2 max-w-3xl">
            ...
            <button className="text-white text-sm font-semibold px-5 py-2.5 rounded-lg hover:opacity-90 transition-opacity whitespace-nowrap" style={{ background: 'linear-gradient(135deg, #533483 0%, #0f3460 100%)' }}>
              Search Schools
            </button>
          </div>
          ...
          <div className="flex flex-wrap gap-6 mt-8">
            {[
              ...
              { value: '95%', label: 'Avg University Placement' },
        ...
        <div className="flex gap-8">
          ...
          <aside className="w-56 flex-shrink-0 hidden lg:block">
            <div className="sticky top-20 space-y-6">
              ...
              <FilterSection title="Curriculum">
                {['igcse', 'a_level', 'edexcel', 'ib'].map((c) => (
                  <label key={c} className="flex items-center gap-2 text-sm text-slate-700 cursor-pointer hover:text-[#0f3460]">
                    <input type="checkbox" className="accent-[#533483]" />
                    {curriculaLabels[c]}
                  </label>
                ))}
              </FilterSection>
              ...
              <FilterSection title="State">
                {['Lagos', 'FCT - Abuja', 'Rivers', 'Oyo', 'Kano', 'Ogun'].map((s) => (
              ...
              <FilterSection title="School type">
                {['Private', 'International', 'Government'].map((t) => (
                  <label key={t} className="flex items-center gap-2 text-sm text-slate-700 cursor-pointer hover:text-[#0f3460]">
                    <input type="radio" name="type" className="accent-[#533483]" />
                    {t}
                  </label>
                ))}
              </FilterSection>
              ...
              <FilterSection title="Annual fee (NGN)">
                <div className="flex gap-2">
                  <input type="number" placeholder="Min" className="w-full px-2 py-1.5 border border-slate-200 rounded-lg text-xs focus:outline-none focus:ring-1 focus:ring-[#533483]" />
                  <input type="number" placeholder="Max" className="w-full px-2 py-1.5 border border-slate-200 rounded-lg text-xs focus:outline-none focus:ring-1 focus:ring-[#533483]" />
                </div>
              </FilterSection>

              <FilterSection title="Features">
                {['Boarding available', 'Day school', 'A*/A rate > 80%', 'Verified only'].map((f) => (
                  <label key={f} className="flex items-center gap-2 text-sm text-slate-700 cursor-pointer hover:text-[#0f3460]">
                    <input type="checkbox" className="accent-[#533483]" />
                    {f}
                  </label>
                ))}
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between mb-6">
              <div className="text-slate-600 text-sm"><span className="font-bold text-slate-900">243</span> schools found</div>
              <select className="border border-slate-200 rounded-lg px-3 py-2 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#533483]">
                <option>Sort: Highest rated</option>
                <option>Sort: Lowest fees</option>
                <option>Sort: Highest A*/A rate</option>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap gap-1.5 mt-2">
                        {school.curricula.map((c) => (
                          <span key={c} className="badge-cambridge">{curriculaLabels[c] || c}</span>
                        ))}
                      </div>
            ...
            <div className="flex items-center justify-center gap-2 mt-10">
              {[1, 2, 3, '...', 18].map((p, i) => (
                <button key={i} className={`w-9 h-9 rounded-lg text-sm font-medium transition-colors ${p === 1 ? 'text-white' : 'border border-slate-200 text-slate-700 hover:border-purple-400'}`}
                  style={p === 1 ? { background: 'linear-gradient(135deg, #533483 0%, #0f3460 100%)' } : {}}>
                  {p}
                </button>
              ))}
            </div>
